export function buildTrackingCore(figures) {
    const questions = [
    ...
    if (figures.length >= 2 && figures.length <= 7)
        questions.push(...electoralPreferenceQuestions(figures));
    return questions;
}
function electoralPreferenceQuestions(figures) {
